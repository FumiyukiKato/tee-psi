...
sgx_status_t judge_contact(uint8_t session_token[32], uint8_t gcm_tag[16], uint8_t* encrypted_history_data, size_t array_size, uint8_t risk_level[1], uint8_t* result, size_t result_size);
