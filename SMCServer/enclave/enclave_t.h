...
sgx_status_t judge_contact(uint8_t session_token[32], uint8_t encrypted_secret_key[16], uint8_t secret_key_gcm_tag[16], uint8_t* encrypted_history_data, size_t toal_size, uint8_t* gcm_tag, size_t gcm_tag_total_size, size_t* size_list, size_t data_num, uint8_t risk_level[1], uint8_t result_mac[16]);
